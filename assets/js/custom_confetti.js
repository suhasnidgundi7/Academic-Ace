...
function Draw() {
    if (particles.length === 0) {
        // No particles left, stop animation
        return;
    }
...
document.getElementById("done-button").addEventListener("click", function () {
    ...
    setTimeout(stopConfettiAnimation, 1000); // 1000 milliseconds (1 seconds)
});

function startConfettiAnimation() {
    animationInterval = setInterval(Draw, 1000 / 60); // 60 FPS animation
